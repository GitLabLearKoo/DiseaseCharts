...
import com.moxtar.android.chart.disease.utils.ChartComparator;
 ...
 *       以便于{@link com.moxtar.android.chart.model.Observer}更新数据时调用。
 ...
 * 5. 实现{@link com.moxtar.android.chart.model.Observer}类
 *    并在{@link com.moxtar.android.chart.model.Observer#update}中调用get方法。
 */
class ChinaData {
    // 封装了信息，被get方法返回的成员变量。
